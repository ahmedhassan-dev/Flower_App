...
import 'package:ecommerce_app/shared/data_from_firestore.dart';
import 'package:ecommerce_app/shared/user_img_from_firestore.dart';
...
// backgroundColor: Color.fromARGB(66, 73, 127, 110),
        ...
        drawer: Consumer<Cart>(builder: ((context, cartt, child) {
          return Drawer(
            child: Column(
              ...
              children: [
                Column(
                  children: [
                    UserAccountsDrawerHeader(
                        ...
                        accountName: GetUserName(documentId: credential!.uid)),
                    ListTile(
                ...
                Container(
                  ...
                  child: const Text("Developed by Ahmed Hassan © 2023",
